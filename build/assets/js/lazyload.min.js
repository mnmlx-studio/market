...
!function (n, t) {
  ...
  function n() {
    ...
    return function (n, t, e) {
      var i = "data-ll-status";null !== e ? n.setAttribute(i, e) : n.removeAttribute(i);
    }(n, 0, t);
  },
      A = function A(n) {
    return w(n, null);
    ...
    for (var t, e = [], i = 0; t = n.children[i]; i += 1) {
      ...
      D = function D(n, t) {
    var e = n.parentNode;e && "PICTURE" === e.tagName && j(e).forEach(t);
  },
      H = function H(n, t) {
    j(n).forEach(t);
  },
    ...
    if (!P(n)) {
      ...
      q = function q(n, t) {
    if (P(n)) {
      var e = S(n);t.forEach(function (t) {
        !function (n, t, e) {
    ...
    var i = z(n) || n;on(i) || function (n, t, e) {
      on(n) || (n.llEvLisnrs = {});var i = "VIDEO" === n.tagName ? "loadeddata" : "load";tn(n, i, t), tn(n, "error", e);
    }(i, function (o) {
      !function (n, t, e, i) {
        var o = O(t);rn(t, e, i), N(t, e.class_loaded), w(t, b), C(e.callback_loaded, t, i), o || nn(e, i);
      }(0, n, t, e), an(i);
    }, function (o) {
      !function (n, t, e, i) {
        var o = O(t);rn(t, e, i), N(t, e.class_error), w(t, m), C(e.callback_error, t, i), e.restore_on_error && q(t, B), o || nn(e, i);
      }(0, n, t, e), an(i);
    });
  },
    ...
    !function (n) {
      ...
      !function (n) {
        ...
        var i = y(n, t.data_bg),
            ...
            r = a && o ? o : i;r && (n.style.backgroundImage = 'url("'.concat(r, '")'), z(n).setAttribute(u, r), Q(n, t, e));
      }(n, t, e), function (n, t, e) {
        var i = y(n, t.data_bg_multi),
            o = y(n, t.data_bg_multi_hidpi),
            r = a && o ? o : i;r && (n.style.backgroundImage = r, K(n, t, e));
      }(n, t, e), function (n, t, e) {
        var i = y(n, t.data_bg_set);if (i) {
          var o = i.split("|"),
              a = o.map(function (n) {
      ...
      cn(n, t, e), function (n, t, e) {
        var i = Y[n.tagName];i && (i(n, t), Q(n, t, e));
      }(n, t, e);
    }(n, t, e);
  },
      un = function un(n) {
    ...
    D(n, function (n) {
      ...
      dn = { IMG: sn, IFRAME: function IFRAME(n) {
      q(n, V);
      ...
      fn = function fn(n, t) {
    (function (n) {
      var t = dn[n.tagName];t ? t(n) : function (n) {
        if (P(n)) {
          var t = S(n);n.style.backgroundImage = t.backgroundImage;
        }
      }(n);
    })(n), function (n, t) {
    ...
    n.forEach(function (n) {
      return function (n) {
        ...
        }(n);w(n, "entered"), N(n, e.class_entered), M(n, e.class_exited), function (n, t, e) {
    ...
    return function (n) {
      ...
      En = function En(n, e) {
    var o = c(n);this._settings = o, this.loadingCount = 0, function (n, t) {
      ...
      t && (e._onlineHandler = function () {
        !function (n, t) {
          var e;(e = pn(n), bn(e).filter(mn)).forEach(function (t) {
            M(t, n.class_error), A(t);
          }), t.update();
        }(n, e);
      }, window.addEventListener("online", e._onlineHandler));
    }(o, this), this.update(e);
  };return En.prototype = { update: function update(n) {
      var t,
          o,
          a = this._settings,
          r = hn(n, a);G(this, r.length), !e && i ? gn(a) ? function (n, t, e) {
        n.forEach(function (n) {
      ...
      var t = this,
          e = this._settings;hn(n, e).forEach(function (n) {
        T(n, t), ln(n, e, t);
      });
    }, restoreAll: function restoreAll() {
      var n = this._settings;pn(n).forEach(function (t) {
        fn(t, n);
      });
